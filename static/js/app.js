let isRecording = false;
        ...
        function startRecording() {
            ...
            fetch('/audio/start_recording', { method: 'POST' })
                .then(r => r.json())
                .then(data => {
                    if (!data.success) showMessage('Error: ' + data.message, 'error');
                })
        ...
        function stopRecording() {
            ...
            fetch('/audio/stop_recording', { method: 'POST' })
                .then(r => r.json())
                .then(data => {
                    if (data.success) {
                        showMessage('Grabación completada', 'success');
                    } else {
